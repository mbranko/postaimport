...
public class FixIntOznSerial {
    public static void main(String[] args) throws Exception {
        ...
        if (!(cmdLine.hasOption("i") && cmdLine.hasOption("o"))) {
            ...
            formatter.printHelp("FixIntOznSerial", options);
            return;
        }
